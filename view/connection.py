...
class Connection:
    ...
    def create_widgets(self):
        ...
        self.connexion_button = Button(self.root, text="Se connecter", command=self.login,  font=('Arial', 14), bg='white', fg='#DB0000', padx=20, pady=10, bd=0, activebackground='#FF5733', activeforeground='white')
